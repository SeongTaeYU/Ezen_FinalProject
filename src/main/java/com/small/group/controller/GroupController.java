...
public class GroupController {
	...
	@GetMapping("/groupList")
	   public String getGroupList(PageRequestDTO pageRequestDTO,
	       ...
	       if (groupName != null) {
	           pageRequestDTO.setGroupName(groupName);
	       } else {
	           // groupCategoryNo가 없을 경우 전체 그룹을 가져오도록 설정
	           pageRequestDTO.setGroupName(null);
	       }
	...
	// 그룹 한 개 조회
	  ...
	  */
		...
		public String updateGroup(@ModelAttribute @Valid GroupDTO dto, BindingResult bindingResult, Model model) {
	 ...
	 @PostMapping("/groupDelete/{groupNo}")
